...
public class OtherImpInfo {
    /*
    * 2 Public Class Not allowed in single .java
    ...
    * */
    ...
    public static void main(String[] args){
        ...
        // I think this fixed in newer java version
        /*
    ...
    /* Always use .equals() */
        try {
            OtherImpInfo otherImpInfo = new OtherImpInfo();
            otherImpInfo.testException();
        } catch (Exception e ) {
